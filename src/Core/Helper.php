...
class Helper {
	...
	{
	    $folder = isset($_COOKIE['media-library-folder']) ? '' : config('media-library.folder');
	...
	static function getCurrentFolderModel() {
	    return Model::where('path', config('media-library.folder'))->first();
    }
